...
toolBarIoton.config =
  custom:
    ...
    description: 'A cson or json file path containing extra entries. Path should be relative to the Atom\'s configuration directory (.atom). For details read ioton\'s README.md file'
    type: 'string'
    default: ''
